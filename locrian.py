# Program to generate the sounds of notes of a locrian scale matching the frequencies of notes in piano
...
def load_notes(notestep, notestep1, notescale):
    ...
    # Interval of notes for a locrian scale
    notes_interval = [1, 2, 2, 1, 2, 2, 2, 1] 
    rev_interval = [0, 2, 2, 2, 1, 2, 2, 1]
    tones_fwd, tones_rev = [], []
    
    print(f'The frequencies in Hz of ascending notes for {notescale} in the locrian scale')
    ...
    print()
    print(f'The frequencies in Hz of descending notes for {notescale} in the locrian scale')
    ...
    # Return list of frequencies in the ascending and descending notes of the locrian scale    
...
# Scale list for which the locrian scale will be played in sequence
scale_list = ['C4']
